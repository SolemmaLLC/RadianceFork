...
THREADLOCAL static char	*meshfn;	/* input file name */
THREADLOCAL static FILE	*meshfp;	/* mesh file pointer */
THREADLOCAL static int	objsize;	/* sizeof(OBJECT) from writer */
